...
import { ArrowLeft, Search, SlidersHorizontal, Users, ChevronDown, MessageSquare } from "lucide-react";
          ...
          <div className="space-y-4">
            {caseStudies.map((study) => {
              ...
              return (
                <div
                  key={study.id}
                  className="flex items-center gap-6 p-4 border border-[#EDEDED] rounded-2xl hover:shadow-md transition-shadow cursor-pointer"
                  onClick={() => router.push(`/interview/case-study/${study.id}`)}
                >
                  {/* Thumbnail */}
